<%@ Page Title="" Language="C#" MasterPageFile="~/Front.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TempService.index" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>Unwrap joy on <em>YOUR TIME</em></h1>
                        <p>Tick-tock, it’s gift o’clock! At Timeless Treasures, not only do we have the quirkiest, funkiest gifts, 
          but we also let you play with time. Choose a gift now, and schedule it to arrive just when you want—whether it’s tomorrow or next year!
          Because the best surprises are always perfectly timed.</p>
            ...
            <div class="footer-content">
                <div class="row">
                    ...
                    <div class="right-content col-lg-6 col-md-12 col-sm-12">
                        <h2>More About <em>Timeless Treasures</em></h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sub-footer">
                        <p>Copyright &copy; 2024 Timeless Treasures Landing Page
